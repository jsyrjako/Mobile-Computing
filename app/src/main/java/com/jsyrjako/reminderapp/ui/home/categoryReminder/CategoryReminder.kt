package com.jsyrjako.reminderapp.ui.home.categoryReminder
...
import com.jsyrjako.reminderapp.data.entity.Reminder
...
private fun Date.formatToString(): String {
    return SimpleDateFormat("MMMM dd,y yyyy", Locale.getDefault()).format(this)
}